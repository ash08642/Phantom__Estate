<x-layout>
<form method="POST" action="/" enctype="multipart/form-data" class="max-w-5xl bg-gray-50 mx-auto my-4 rounded border-2 p-6 shadow-xl">
  @csrf
      ...
      <div class="col-span-full">
        ...
        <script>
          ...
          photo.onchange = function(){
            picture.src = URL.createObjectURL(photo.files[0]);
          }
        </script>
      </div>
    </div>
  ...
  <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 border-b border-gray-900/10 pb-10">
    <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <select id="propertytype" name="propertytype" autocomplete="propertytype" class="block w-full rounded-md border-gray-300 focus:border-secondary-500 focus:ring-secondary-500 shadow-sm py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <select id="purchasetype" name="purchasetype" autocomplete="purchasetype" class="block w-full rounded-md border-gray-300 focus:border-secondary-500 focus:ring-secondary-500 shadow-sm py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
            <option>Buy</option>
            <option>Rent</option>
          </select>
        </div>
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <x-text-input id="agentfirstname" class="block w-full rounded-md py-1.5 text-gray-900 shadow-sm ring-gray-300 sm:text-sm sm:leading-6"
            type="text"
            name="agentfirstname"
            value="{{old('agentfirstname')}}"
            autocomplete="given-name"/>
        </div>
        @error('agentfirstname')
          <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-2" role="alert">
  ...
  <div class="mt-6 flex items-center justify-end gap-x-6">
    <a href="/" class="text-sm text-red-400 font-semibold leading-6 text-gray-900">Cancel</a>
    <button type="submit" class="rounded-md bg-secondary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-secondary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create</button>
  </div>
</form>
</x-layout>